...
/**
 * <h1>S_wheel</h1>
 * This class is a subsystem for the drive train wheels. Includes objects for motor controllers
 * that control the drive train wheels.
 * <br>Sidenote: So when I was in the process of changing the
 * robot from a basic configuration to a command based configuration, I didn't have a chance to fix
 * several of the commands to use the subsystem instead of the commands. This isn't a huge deal since
 * the robotmap covers any port changes anyway. It is triggering my OCD though. :)
 *
